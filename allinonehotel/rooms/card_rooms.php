      ...
      <div class="block">
        ...
        $conn=new DBConnect();
            if(isset($_POST['book_room'])){
                ...
                $sql="Insert into bookings(room_name,username,check_in_date,check_out_day,price) values('$room_name3','$booking_name','$check_in','$check_out','$price1')";
                     ...
                     if(p=="no_login"){
                        ...
                        if(Array.isArray(p)){
                          ...
                          for(var j=0;j<p.length;p++){
                            ...
                            str+="</div><div style='padding-left:14px;padding-bottom:10px;'>";
                            ...
                            str+="<button class='btn btn-success mb-2' data-bs-toggle='modal' onclick=\"booking('"+p[j]["roomname"]+"','"+p[j]["price"]+"')\">Book Now</button>";
                            str+='<button onclick="checking(\''+p[j]["roomname"]+'\')" class="btn btn-primary mb-2">Check Details</button>';
                            str+="</div></div>";
                             }
                          str+="</div></div>";
                          if(p.length>0) document.getElementById('recommendation').innerHTML=str;
                        }
                      }
