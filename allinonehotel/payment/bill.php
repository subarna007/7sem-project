...
$conn=new DBConnect();
 if(isset($_GET["id"])){
    if(!empty($_GET["id"])||$_GET["id"]!=""){
        $result1=$conn->own_query("Select b.room_name,b.price,b.payment_date,u.id, u.full_name, u.username, u.address, u.contact from user_details u inner join bookings b where b.user_id=u.id and check_in_date='".$_GET["cin"]."' and check_out_day='".$_GET["cout"]."' and b.user_id=".$_GET["id"]." and b.payment_date='0'");
                ...
                <div class="mt-4">
                    ...
                    <div>
                        ...
                        <form action="https://uat.esewa.com.np/epay/main" method="POST">
                                ...
                                <?php echo ' <input value="http://localhost/7sem/allinonehotel/payment/success.php?id='.$_GET["id"].'&cin='.$_GET["cin"].'&cout='.$_GET["cout"].'&package='.$_GET["package"].'&pkg_price='.$_GET["pkg_price"].'" type="hidden" name="su">
                                <input value="http://localhost/7sem/allinonehotel/payment/failure.php?" type="hidden" name="fu">
                               ';?>
